...
public class SingleMovie extends HttpServlet
{
		...
		throws IOException, ServletException
	{
		...
		try{
		    ...
		    ResultSet result = statement.executeQuery("Select * from movies where id = " + movieID); 
			...
			RequestDispatcher RequetsDispatcherObj = request.getRequestDispatcher("/SingleMovie.jsp");
